...
interface Experience {
  ...
  logo: string
  type?: string
  employmentType: "freelance" | "company" // Simplified employment type
}
...
export default function ExperienceTimeline({ experiences }: ExperienceTimelineProps) {
  ...
  useEffect(() => {
    if (filter === "all") {
      ...
      setFilteredExperiences(experiences.filter((exp) => exp.employmentType === filter))
    }
                ...
                >
                  ...
                  <div className="flex flex-wrap items-center mb-4 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div className="ml-auto">
                      ...
                      >
                        {exp.employmentType === "freelance" ? t("experience.freelance") : t("experience.company")}
                      </span>
                    </div>
                  </div>

                  <p className="mb-4 text-gray-600 dark:text-gray-300 leading-relaxed">{exp.description}</p>
